      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {businessFeatures.map((feature, index) => <Card key={index} className="border-2 hover:border-maxmove-500 transition-all">
                <CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4">
                {integrationFeatures.map((feature, index) => <li key={index} className="flex items-start">
  ...
  type: "express"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              {businessFaqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`}>
      ...
      <section className="py-20 bg-maxmove-950 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button size="lg" variant="default" onClick={() => navigate("/signup?type=business")}>
            Try it now
          </Button>
        </div>
      </section>
