...
const ServiceBanners = () => {
  ...
  return (
    <section className="relative">
      {/* Background Image */}
      <div 
        className="absolute inset-0 z-0 bg-[url('/lovable-uploads/18efedbc-fa85-4a03-978b-d62558e7ea5b.png')] bg-cover bg-center md:bg-[center_40%] bg-[20%_center] md:!h-[100vh]"
        style={{
          height: "55vh",
        }}
      >
      ...
      <div className="relative z-10 pt-16 md:pt-48 pb-4 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto min-h-[50vh] md:min-h-[90vh] flex flex-col items-center">
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-6 mt-8 md:mt-24 w-full">
          {/* Move Banner */}
          <Link 
            to="/book" 
