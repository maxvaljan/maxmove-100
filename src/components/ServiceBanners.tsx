  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div 
        ...
        style={{
          height: "100%", // Changed to 100% to match section height
      ...
      <div className="relative z-10 pt-16 md:pt-48 pb-4 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto min-h-screen flex flex-col items-center">
