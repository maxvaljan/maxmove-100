...
const ServiceBanners = () => {
  ...
  return (
    <section className="relative">
      {/* Background Image */}
      <div 
        className="absolute inset-0 z-0 bg-[url('/lovable-uploads/18efedbc-fa85-4a03-978b-d62558e7ea5b.png')] bg-cover bg-center md:bg-[center_40%] bg-[25%_center] md:!h-[100vh]"
        style={{
          height: "55vh",
        }}
      >
      ...
      <div className="relative z-10 pt-16 md:pt-48 pb-4 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto min-h-[50vh] md:min-h-[90vh] flex flex-col items-center">
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-6 mt-4 md:mt-16 w-full">
          {/* Move Banner */}
          <Link 
            to="/book" 
            className="group relative overflow-hidden p-1 md:p-6 transition-all cursor-pointer bg-white/20 backdrop-blur-md hover:bg-white/30"
          >
            ...
            <Button
              className="mt-1 md:mt-4 bg-maxmove-600 text-white group-hover:bg-white group-hover:text-maxmove-600 hover:bg-white/90 group w-fit text-[10px] md:text-sm px-1.5 py-0.5 md:px-4 md:py-2 scale-[0.7] md:scale-100 origin-left"
            >
              Book Now
